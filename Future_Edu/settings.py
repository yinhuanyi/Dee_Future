# coding: utf-8
"""
Django settings for Future_Edu project.
...
WSGI_APPLICATION = 'Future_Edu.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'debug_level': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',  # 启用轮询日志
            'filename': '%s/logs/debug.log' % BASE_DIR,  # 日志输出文件
    ...
    'loggers': {
        'django_debug_error': {
            'handlers': ['error_level', 'debug_level'],
            'level': 'DEBUG',
            'propagate': True,
        },
    },
...
# 调用django自带的sendmail发送邮件
EMAIL_HOST = "smtp.163.com"
EMAIL_POST = 25
EMAIL_HOST_USER = "yinhuanyi_cn@163.com"
EMAIL_HOST_PASSWORD = "yhy3426356"
EMAIL_USE_TLS = False
